...
function wm.newWindow(title, x, y, w, h)
    ...
    function win:button(title, x, y, callback)
        ...
        local but = button.new(title, x, y, callback)
    ...
    function win:label(title, x, y)
        ...
        local label = label.new(title, x, y)
    ...
    function win:textbox(title, x, y, callback)
        ...
        local textbox = textbox.new(title, x, y, callback)
        table.insert(self.inputs, textbox)
        return textbox
    ...
    function win:slider(win, title, x, y, value, callback)
        ...
        local slider = slider.new(win, title, x, y, value, callback)
